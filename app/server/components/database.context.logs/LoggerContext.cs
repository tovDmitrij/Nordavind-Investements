...
namespace database.context.logs
{
    ...
    public sealed class LoggerContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) =>
            optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=nordavind_investements_logs;Username=postgres;Password=123456;Timeout=300;CommandTimeout=300");
    }
}